...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.ravn.move(115, 320)

        self.c = QPushButton('C', self)
        self.c.resize(50, 50)
        self.c.move(170, 320)

        self.vkv = QPushButton('//', self)
        self.vkv.resize(50, 50)
        self.vkv.move(60, 320)

        self.proz = QPushButton('%', self)
        self.proz.resize(50, 50)
        self.proz.move(5, 320)
        ...
        self.vkv.clicked.connect(self.vkv_1)
        self.proz.clicked.connect(self.proz_1)
